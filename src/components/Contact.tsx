...
const Contact: React.FC<ContactProps> = ({ darkMode }) => {
  ...
  {/* Email */}
  <a 
    href="mailto:beheraabhijeet574@gmail.com" 
  ...
  >
    ...
    <span>beheraabhijeet574@gmail.com</span>
  </a>

  {/* GitHub */}
  <a 
    href="https://github.com/Abhijeet-Behera" 
    target="_blank" 
  ...
  >
    ...
    <span>Abhijeet_Behera</span>
  </a>

  {/* LinkedIn */}
  <a 
    href="https://www.linkedin.com/in/abhijeet-behera-110425255/" 
    target="_blank" 
    rel="noopener noreferrer"
    className={`flex items-center gap-3 transition-colors ${
      darkMode 
